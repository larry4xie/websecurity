...
public class AntPathMatcher implements PathMatcher {
    ...
    public static void main(String[] args) {
    	...
    	System.out.println(pathMatcher.match("**", "index.jsp"));
    	System.out.println(pathMatcher.match("/user/**", "/user/one/index.jsp"));
    	System.out.println(pathMatcher.match("/user/*", "/user/one/index.jsp"));
    	
    	System.out.println(pathMatcher.match("/user/*/*", "/user/one"));
    	System.out.println(pathMatcher.matchStart("/user/*/*", "/user/one"));
	}
